...
class _QRCodePageState extends State<QRCodePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            elevation: 0.0,
            title: Text('Payment'),
            actions: <Widget>[IconButton(icon: Icon(Icons.crop_free), onPressed: _scanQR)]),
        body: Column(children: <Widget>[
                  ...
                  child: Column(children: <Widget>[
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(color: Colors.black.withOpacity(0.1), blurRadius: 30, offset: Offset(0, 20))
                            ]),
                        child: Row(children: <Widget>[
                          Expanded(
                              child: Column(
                                ...
                                Text("136ae**347",
                                    style: TextStyle(
                                        fontSize: 28, color: Colors.grey.shade600, fontWeight: FontWeight.w700)),
                                Gaps.vGap10,
                          ...
                          Container(
                              ...
                              decoration:
                                  BoxDecoration(color: Color.fromARGB(255, 19, 71, 255), shape: BoxShape.circle),
                              child: Container(
                                  height: 27,
                                  width: 27,
                                  alignment: Alignment.center,
                        ...
                        child: Opacity(
                            ...
                            child: BarCodeImage(
                                ...
                                params: Code128BarCodeParams("2690123456789",
                                    withText: true, lineWidth: 1.4, barHeight: 70.0),
          ...
          Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
                ...
                Gaps.hGap24,
                IconButton(icon: Icon(Icons.arrow_forward, color: Colors.white, size: 30), onPressed: () {})
              ]))
        ]));
  }
  ...
  Future _scanQR() async {
    try {
      ScanResult _qrResult = await BarcodeScanner.scan();
      qrResult = _qrResult.rawContent;
      debugPrint("==================$_qrResult");
      setState(() {});
    } catch (ex) {
