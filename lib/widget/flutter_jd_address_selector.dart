...
class _JDAddressDialogState extends State<JDAddressDialog> with TickerProviderStateMixin {
  int _index = 0;
  ...
  void _initData() async {
    ///
    rootBundle.loadString('assets/data/chinese_cities.json').then((value) {
            ...
            onTap: () {
              ...
              switch (_index) {
                ...
                case 3:
                  _index = 2;
                  widget.onSelected(
                      provinces[_positions[0]]["name"], cities[_positions[1]]["name"], counties[_positions[2]]["name"]);
