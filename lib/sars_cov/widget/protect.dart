        ...
        children: <Widget>[
          Expanded(
            child: Button(
              ...
              borderRadius: 5.0,
              textColor: _currentPage == 0 ? Colors.black : Color(0Xff808080),
              height: 40.0,
          ...
          Expanded(
            child: Button(
              ...
              borderRadius: 5.0,
              height: 40.0,
              textColor: _currentPage == 1 ? Colors.black : Color(0Xff808080),
